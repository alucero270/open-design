...
export const en: Dict = {
  'chat.amrCard.switchTitle': 'Model call failed ΓÇö this run is paused',
  'chat.amrCard.switchBody': 'Switch to Open Design\'s official AMR model service ΓÇö no API key setup needed. After you sign in, authorize, and top up, this run retries automatically.',
  ...
  'common.searchEllipsis': 'SearchΓÇª',
  'common.loading': 'LoadingΓÇª',
  'common.all': 'All',
  'common.none': 'None',
  ...
  'app.welcomeLoading': 'Loading workspaceΓÇª',
  ...
  'settings.testRunning': 'Testing connectionΓÇª',
  ...
  'settings.testSuccessApi': 'Connected. Replied in {ms} ms ΓÇö \'{sample}\'',
  'settings.testSuccessCli': '{agentName} replied in {ms} ms ΓÇö \'{sample}\'',
  ...
  'settings.amrSigningIn': 'Signing inΓÇª',
  ...
  'settings.amrLoggingIn': 'Signing inΓÇª',
  'settings.amrLoggingOut': 'Signing outΓÇª',
  ...
  'settings.apiKeyGetLink': 'Get key Γåù',
  ...
  'settings.modelsLoadedFromAccount': 'Γ£ô Loaded {count} models from your account.',
  'settings.modelsLoadedCount': 'Γ£ô Loaded {count} models.',
  ...
  'settings.fetchModelsRunning': 'Fetching modelsΓÇª',
  ...
  'settings.azureModelFetchHint': 'Enter the deployment name from your Azure resource. Azure deployments canΓÇÖt be fetched automatically.',
  ...
  'settings.byokVideoI2vHint': 'Image-to-video model: a reference image is required (the newest project image is used automatically if you donΓÇÖt pick one)',
  ...
  'settings.modelPickerHint': 'Default uses the CLIΓÇÖs own config. CustomΓÇª lets you type any model id.',
  ...
  'settings.modelCustom': 'Custom (type below)ΓÇª',
  ...
  'settings.externalMcpHint': 'Add MCP tools from external services (Higgsfield, GitHub, ΓÇª).',
  ...
  'settings.privacyConsentFooter': 'You can change either of these any time in Settings ΓåÆ Privacy. We never upload the contents of your generated artifact files.',
  ...
  'settings.privacyConsentBannerFooter': 'Data sharing is on by default. You can turn it off any time in Settings ΓåÆ Privacy. We never upload the contents of your generated artifact files.',
  ...
  'settings.mcpHint': 'Let coding agents (Cursor, Claude Code, VS CodeΓÇª) read your Open Design projects directly.',
  ...
  'settings.mcpInstructionAntigravity': 'In Antigravity: Agent panel "..." menu ΓåÆ MCP Servers ΓåÆ Manage MCP Servers ΓåÆ View raw config. Merge this JSON.',
  ...
  'settings.mcpInstructionWindsurf': 'Open {path} (or use the MCPs icon in Cascade ΓåÆ Configure) and merge:',
  ...
  'settings.mcpCodexOneClickUnavailable': 'Codex CLI not found on PATH ΓÇö install Codex or paste the snippet manually.',
  ...
  'settings.mcpCodexBusy': 'WorkingΓÇª',
  ...
  'entry.loadingWorkspace': 'Loading workspaceΓÇª',
  ...
  'homeHero.placeholder': 'Describe what you want to generateΓÇª',
  'homeHero.placeholderActive': 'Edit the example query or write your ownΓÇª',
  ...
  'homeHero.loadingContext': 'Loading contextΓÇª',
  ...
  'workingDirPicker.processing': 'ProcessingΓÇª',
  ...
  'workingDirPicker.replace': 'Replace directoryΓÇª',
  ...
  'designSystemPicker.loading': 'Loading design systemsΓÇª',
  ...
  'designSystemPicker.loadingPreview': 'Loading previewΓÇª',
  ...
  'recentProjects.empty': 'No projects yet ΓÇö type a prompt to start one.',
  ...
  'pluginsHome.loadingCatalog': 'Loading catalogΓÇª',
  'pluginsHome.emptyCatalog': 'Catalog is empty. Bundled plugins ship with Open Design and should appear here automatically ΓÇö try restarting the daemon if this persists.',
  ...
  'pluginsHome.searchPlaceholder': 'Search pluginsΓÇª',
  ...
  'pluginsView.loading': 'Loading pluginsΓÇª',
  ...
  'pluginsView.installing': 'InstallingΓÇª',
  ...
  'pluginsView.refreshing': 'RefreshingΓÇª',
  'pluginsView.removing': 'RemovingΓÇª',
  ...
  'pluginCard.applying': 'ApplyingΓÇª',
  'pluginCard.publish': 'Publish',
  'pluginCard.contribute': 'Contribute',
  'pluginCard.starting': 'StartingΓÇª',
  ...
  'mcpClient.emptyBody': 'Click "Add server" to get started ΓÇö pick a template (Higgsfield OpenClaw, Pollinations, Allyson, Imagician, EdgeOne Pages, GitHub, FilesystemΓÇª) or set up a custom stdio / HTTP server.',
  ...
  'useEverywhere.modalSubtitle': 'Drop Open Design into any IDE, agent, or script ΓÇö CLI, HTTP, MCP, and Skills. Use ΓÇ£Copy guide for an agentΓÇ¥ and paste into Claude Code, Codex, Cursor, openclaw, or hermes to set up everything.',
  ...
  'useEverywhere.footBody': 'Copies a structured markdown guide your agent can act on immediately ΓÇö install, verify, and use.',
  ...
  'useEverywhere.section.overview.intro': 'Open Design is more than a window ΓÇö it is a local privileged daemon (`od`) plus a Skills + Design-Systems + Atoms registry. Once it is running on your machine, any code agent (Claude Code, Codex, Cursor, OpenCode/openclaw, Hermes, your own script) can drive generations, inspect projects, and produce design artifacts through four interchangeable surfaces.',
  'useEverywhere.section.overview.bullet1': 'CLI ΓÇö `od <command>` for headless scripts, CI, and shell automation.',
  'useEverywhere.section.overview.bullet2': 'MCP server ΓÇö wires Open Design as a Model Context Protocol server so any MCP-capable agent can list skills, run scenarios, and read artifacts.',
  'useEverywhere.section.overview.bullet3': 'HTTP API ΓÇö `http://127.0.0.1:7456/api/*` REST + SSE endpoints; the same surface the web UI uses.',
  'useEverywhere.section.overview.bullet4': 'Skills ΓÇö drop-in `SKILL.md` packs (Claude-compatible) that any agent already on your PATH can invoke without Open Design at all.',
  'useEverywhere.section.overview.bullet5': 'Standard artifacts ΓÇö seed real HTML projects from Skills, bundled default plugins, and community plugin examples before the daemon starts.',
  ...
  'useEverywhere.section.cli.bullet1': '`od` (no args) ΓÇö boots the daemon and opens the web UI.',
  'useEverywhere.section.cli.bullet2': '`od media generate ...` ΓÇö produce image / video / audio bytes through the unified media protocol.',
  'useEverywhere.section.cli.bullet3': '`od run ...` ΓÇö start a project run from a prompt + skill.',
  'useEverywhere.section.cli.bullet4': '`od plugin install <source>` / `od plugin apply <id>` ΓÇö install and apply community plugins.',
  'useEverywhere.section.cli.bullet5': '`od skills list` / `od design-systems list` ΓÇö inspect what is available locally.',
  'useEverywhere.section.cli.bullet6': '`od status` / `od doctor` ΓÇö verify daemon health and detect agent CLIs on your PATH.',
  ...
  'useEverywhere.section.cli.snippet5': 'Verify environment + detected agents (Claude, Codex, Cursor, ΓÇª)',
  'useEverywhere.section.cli.footer': 'All subcommands accept `--daemon-url http://127.0.0.1:<port>` to target a specific running daemon ΓÇö useful when running a sandboxed second instance for tests.',
  ...
  'useEverywhere.section.mcp.intro': 'Open Design ships with a Model Context Protocol server (`od mcp`) that lets any MCP-capable client ΓÇö Cursor, Claude Code, Antigravity, VS Code Copilot Chat, openclaw, hermes ΓÇö discover Open Design tools (list skills, render previews, generate media, run plugins) without shelling out manually. The daemon publishes a ready-to-paste install snippet via `GET /api/mcp/install-info` for each major client.',
  'useEverywhere.section.mcp.bullet1': 'Stdio transport ΓÇö no extra port, the client spawns `od mcp` directly.',
  ...
  'useEverywhere.section.mcp.snippet1': 'Generic MCP client config (works in Cursor, Claude Code, Codex, ΓÇª)',
  ...
  'useEverywhere.section.mcp.footer': 'In the Open Design app, open Settings ΓåÆ Integrations to copy a client-specific install command (Cursor, Claude Code, Antigravity, VS Code) instead of editing JSON by hand.',
  ...
  'useEverywhere.section.http.bullet1': '`GET /api/health` ΓÇö daemon liveness.',
  'useEverywhere.section.http.bullet2': '`GET /api/skills` and `GET /api/design-systems` ΓÇö available registries.',
  'useEverywhere.section.http.bullet3': '`GET /api/projects` and `POST /api/projects` ΓÇö list and create projects (POST returns the project + first conversation).',
  'useEverywhere.section.http.bullet4': '`GET /api/projects/:id/chat` ΓÇö SSE stream of agent events for a conversation.',
  'useEverywhere.section.http.bullet5': '`POST /api/plugins/:id/apply` ΓÇö bind an installed plugin and get its rendered example query + inputs.',
  'useEverywhere.section.http.bullet6': '`GET /api/agents` ΓÇö detected code-agent CLIs on your PATH.',
  ...
  'useEverywhere.section.http.snippet3': 'Stream a chat turn (SSE ΓÇö each line is JSON-Lines compatible)',
  'useEverywhere.section.http.footer': 'Pure TypeScript types for every request/response live in `@open-design/contracts` ΓÇö import them in your script for full autocomplete without wiring a generator.',
  'useEverywhere.section.skills.tab': 'Skills & headless',
  'useEverywhere.section.skills.heading': 'Drop-in Skills for any agent ΓÇö even without Open Design running',
  'useEverywhere.section.skills.intro': 'A Skill is a directory with a Claude-compatible `SKILL.md` (YAML front-matter + body). Open Design extends the format with the `od:` namespace (`mode`, `preview`, `design_system`, `inputs`, ΓÇª) so the same artifact can be used both inside Open Design and by a vanilla agent like Claude Code, Codex, openclaw, or hermes. Discovery follows a precedence chain so projects can override their own skills.',
  'useEverywhere.section.skills.bullet1': 'Discovery: `./.claude/skills/` ΓåÆ `./skills/` ΓåÆ `~/.claude/skills/` (project wins).',
  ...
  'routines.fieldPromptPlaceholder': 'Pull yesterdayΓÇÖs GitHub + Linear activity and summarize what changed.',
  ...
  'routines.describe.weekdays': 'Runs MonΓÇôFri at {time} {tz}',
  ...
  'routines.pickProject': 'ΓÇö Pick a project ΓÇö',
  'routines.targetReuse': 'ΓåÆ {project}',
  'routines.targetCreate': 'ΓåÆ new project each run',
  ...
  'routines.save': 'Save',
  'routines.saving': 'SavingΓÇª',
  'routines.create': 'Create',
  'routines.creating': 'CreatingΓÇª',
  ...
  'routines.errorPickProject': 'Pick a project to reuse, or switch to ΓÇ£Create new each runΓÇ¥',
  'routines.errorAgentEmptyOutput': 'Agent completed without producing any output. The model or provider may have returned an empty response ΓÇö check the agent logs for upstream errors.',
  'entry.helpAria': 'Help',
  ...
  'promptTemplates.searchPlaceholder': 'Search templatesΓÇª',
  ...
  'connectors.toolsLoading': 'Loading toolsΓÇª',
  ...
  'connectors.searchPlaceholder': 'Search connectorsΓÇª',
  'connectors.searchAriaLabel': 'Search connectors by name, provider, or tool',
  'connectors.searchClear': 'Clear search',
  'connectors.emptyNoMatchTitle': 'No connectors match ΓÇ£{query}ΓÇ¥',
  ...
  'newproj.toggleSpeakerNotesHint': 'Less text on slides ΓÇö keep talking points in notes.',
  ...
  'newproj.modelSearch': 'Search modelsΓÇª',
  ...
  'newproj.connectorsEmptyCta': 'Set up connectors ΓåÆ',
  'newproj.connectorsLoading': 'Loading connectorsΓÇª',
  ...
  'newproj.promptTemplateOptimizeHint': 'Edit anything ΓÇö your changes carry into the agent\'s brief.',
  'newproj.promptTemplateBodyEmpty': 'Empty body ΓÇö the agent will get no template reference.',
  ...
  'designs.searchPlaceholder': 'SearchΓÇª',
  ...
  'designs.statusRefreshing': 'RefreshingΓÇª',
  ...
  'examples.searchPlaceholder': 'Search examplesΓÇª',
  ...
  'examples.openPreview': 'Γñó Open preview',
  'examples.loadingPreview': 'Loading previewΓÇª',
  ...
  'examples.unavailablePlaceholder': 'No shipped {kind} preview ΓÇö open to learn more',
  'examples.shareUnavailable': 'No shipped {kind} preview to share',
  'examples.shareMenu': 'Share Γû╛',
  'examples.exportPdfAllSlides': 'Export as PDF (all slides)',
  'examples.exportPptxLocked': 'Export as PPTXΓÇª (open template first)',
  ...
  'ds.searchPlaceholder': 'Search design systemsΓÇª',
  ...
  'ds.specLoading': 'Loading DESIGN.mdΓÇª',
  ...
  'socialShare.deployFirst': 'Deploy then shareΓÇª',
  ...
  'inlineSwitcher.daemonOffline': 'Daemon offline ΓÇö open settings',
  ...
  'inlineSwitcher.missingApiKey': 'API key not set ΓÇö open Settings to add it.',
  ...
  'project.customInstructionsPlaceholder': 'Instructions for this project (injected on every message)ΓÇª',
  'project.resizeChatPanel': 'Resize chat panel',
  'project.instructionsActive': 'Active ΓÇö included in every message',
  'chat.tabChat': 'Chat',
  'chat.tabComments': 'Comments',
  'chat.commentsSoon': 'Comments ΓÇö coming soon',
  ...
  'chat.comments.placeholder': 'Comment on this elementΓÇª',
  ...
  'chat.comments.sending': 'SendingΓÇª',
  ...
  'chat.composerPlaceholder': 'Describe what you want to generateΓÇª',
  ...
  'chat.composerHint': 'Γîÿ/Ctrl + Enter to send ┬╖ include goals, content, style, and format',
  ...
  'chat.importDesignSystemSearch': 'Search design systemsΓÇª',
  'chat.importDesignSystemEmpty': 'No design systems match "{query}"',
  'chat.importDesignSystemNone': 'None ΓÇö freeform',
  ...
  'chat.designToolbox.prompt.autoMatchStep1': '1. Define what ΓÇ£good-looking designΓÇ¥ means first: audience, business goal, brand feel, style references, information density, color/type/motion/asset standards, and AI/template patterns to avoid.',
  ...
  'chat.mentionNoResults': 'No results for ΓÇ£{query}ΓÇ¥.',
  ...
  'preview.exit': 'Γñô Exit',
  'preview.fullscreen': 'Γñó Fullscreen',
  'preview.closeTitle': 'Close (Esc)',
  'preview.loading': 'Loading {label}ΓÇª',
  ...
  'workspace.loadingSketch': 'Loading sketchΓÇª',
  'workspace.newTab': 'New tab',
  'workspace.searchFilesPlaceholder': 'Search tabs or filesΓÇª',
  ...
  'workspace.terminalStarting': 'Starting terminalΓÇª',
  ...
  'designFiles.searchPlaceholder': 'Search filesΓÇª',
  'designFiles.up': 'Up',
  ...
  'designFiles.dropTitle': 'Γñô Drop files here',
  'designFiles.dropDesc': 'Images, docs, references, or folders ΓÇö the agent will use them as context.',
  ...
  'designFiles.moveNewFolder': 'New folderΓÇª',
  ...
  'designFiles.pageInfo': '{start}ΓÇô{end} of {total}',
  ...
  'quickSwitcher.placeholder': 'Open tab or fileΓÇª',
  ...
  'fileViewer.markdownStreamingMeta': 'Streaming previewΓÇª',
  'fileViewer.markdownErrorMeta': 'Preview may be incomplete (generation error).',
  'fileViewer.markdownStreamingStatus': 'StreamingΓÇª showing partial markdown.',
  ...
  'manualEdit.uploadingImage': 'Uploading imageΓÇª',
  ...
  'fileViewer.viewportTabletTitle': 'Tablet preview at 820 ├ù 1180 (modern portrait baseline)',
  'fileViewer.viewportMobile': 'Mobile',
  'fileViewer.viewportMobileTitle': 'Mobile preview at 390 ├ù 844',
  ...
  'fileViewer.shareLinkPublishGuide': 'Publish online above to enable share Γåæ',
  ...
  'fileViewer.exportImageSaving': 'Saving imageΓÇª',
  ...
  'fileViewer.saveAsTemplate': 'Save as templateΓÇª',
  'fileViewer.savingTemplate': 'Saving templateΓÇª',
  'fileViewer.savedTemplate': 'Saved as "{name}"',
  'fileViewer.savedTemplateFail': 'Could not save template ΓÇö try again.',
  'fileViewer.templateNamePrompt': 'Template name',
  'fileViewer.templateNameDefault': 'Untitled template',
  'fileViewer.templateDescPrompt': 'Short description (optional ΓÇö what makes this template useful?)',
  'liveArtifact.refresh.button': 'Refresh',
  'liveArtifact.refresh.buttonTitle': 'Refresh this live artifact',
  'liveArtifact.refresh.loadingTitle': 'Loading live artifactΓÇª',
  'liveArtifact.refresh.noSourceTitle': 'No refresh source is available yet.',
  'liveArtifact.refresh.running': 'RefreshingΓÇª',
  ...
  'liveArtifact.refresh.eventStartedDetail': 'Refresh startedΓÇª',
  ...
  'liveArtifact.viewer.code.loading': 'Loading codeΓÇª',
  ...
  'fileViewer.deployingToVercel': 'Deploying to VercelΓÇª',
  ...
  'fileViewer.deployingToProvider': 'Deploying to {provider}ΓÇª',
  'fileViewer.preparingPublicLink': 'Preparing public linkΓÇª',
  ...
  'fileViewer.cloudflareZonesLoading': 'Loading Cloudflare domainsΓÇª',
  ...
  'fileViewer.savingConfig': 'SavingΓÇª',
  ...
  'assistant.forkingConversation': 'ForkingΓÇª',
  'assistant.shareToOpenDesign': 'Share to Open Design',
  'assistant.shareToOpenDesignBusy': 'SharingΓÇª',
  ...
  'assistant.slowHint': 'Taking longer than usual. The form usually shows in 5ΓÇô10s ΓÇö you can Stop and rephrase.',
  ...
  'qf.lockedSubmitted': 'Answers sent ΓÇö agent is using these for the rest of the session.',
  'qf.lockedPrev': 'This form is from a previous turn.',
  'qf.hint': 'Pick what fits. Skip optional fields you don\'t care about ΓÇö the agent will use sensible defaults.',
  ...
  'questions.generating': 'Generating questionsΓÇª',
  ...
  'critiqueTheater.interrupting': 'InterruptingΓÇª',
  ...
  'critiqueTheater.transcriptLoading': 'Loading transcriptΓÇª',
  ...
  'pet.tabBuiltInHint': 'Curated companions bundled with Open Design ΓÇö pick one and adopt.',
  ...
  'pet.tabCommunityHint': 'Hatched pets from Codex ΓÇö adopt one or generate a new one.',
  ...
  'pet.customHint': 'Pick a name, glyph and accent ΓÇö the overlay updates live.',
  'pet.customGreetingPlaceholder': 'Say hi from your petΓÇª',
  'pet.fieldName': 'Name',
  'pet.fieldGlyph': 'Glyph',
  'pet.fieldGlyphHint': 'A single emoji works best (e.g. ≡ƒÉ¥, ≡ƒªä, ≡ƒÉó).',
  ...
  'pet.spriteAria': '{name} ΓÇö drag to move, click to chat',
  ...
  'pet.composerTitle': 'Pets ΓÇö wake, tuck, or pick one',
  ...
  'pet.atlasActiveHint': 'Animated atlas active ΓÇö the pet picks a row from your interaction (hover, drag, idle).',
  ...
  'pet.slashPopoverHint': 'ΓåæΓåô navigate ┬╖ enter to pick ┬╖ esc to dismiss',
  ...
  'pet.codexLoading': 'Looking for hatched petsΓÇª',
  'pet.codexRefresh': 'Refresh',
  'pet.codexAdopt': 'Adopt',
  'pet.codexAdopting': 'AdoptingΓÇª',
  'pet.communitySync': 'Download community pets',
  'pet.communitySyncing': 'DownloadingΓÇª',
  ...
  'pet.codexBundledTitle': 'Ships with Open Design ΓÇö no download needed.',
  ...
  'settings.skillsSaving': 'SavingΓÇª',
  ...
  'settings.projectLocationsAddFolder': 'Add folderΓÇª',
  ...
  'settings.connectorsSavedWithTail': 'Saved ┬╖ ΓÇóΓÇóΓÇóΓÇó{tail}',
  ...
  'settings.connectorsKeySaved': 'Saved Γ£ô',
  ...
  'settings.memoryDesc': 'One sentence ΓÇö what is this memory about?',
  ...
  'settings.memoryStarterProjectDesc': 'Open Design v0.5 ΓÇö chat-driven design editor',
  ...
  'settings.memorySaveHint': 'Not auto-saved ΓÇö click Create / Save to apply.',
  'settings.memoryIndexSaveHint': 'Edits to the index are not auto-saved ΓÇö click Save index to apply.',
  'settings.memoryIndexUnsaved': 'Unsaved changes',
  'settings.memoryFlashCreated': 'Γ£ô Memory created',
  'settings.memoryFlashSaved': 'Γ£ô Memory saved',
  'settings.memoryFlashDeleted': 'Γ£ô Memory deleted',
  'settings.memoryFlashIndexSaved': 'Γ£ô Index saved',
  'settings.memoryFlashPathCopied': 'Γ£ô Path copied',
  ...
  'settings.memoryExtractionsRefreshing': 'RefreshingΓÇª',
  'settings.memoryExtractionPhaseRunning': 'RunningΓÇª',
  ...
  'settings.memoryExtractionSkipEmpty': 'Empty user message ΓÇö nothing to extract.',
  ...
  'settings.orbit.running': 'RunningΓÇª',
  ...
  'settings.orbit.pausedManualOnly': 'Paused ΓÇö manual runs only',
  ...
  'settings.orbit.templateHelp': 'Steer Orbit with a skill ΓÇö the selected template example prompt is injected into every Orbit run so summaries follow that template shape.',
  'settings.orbit.templateAria': 'Orbit prompt template',
  'settings.orbit.templatesLoading': 'Loading templatesΓÇª',
  ...
  'settings.orbit.artifactMetaLegacy': 'Generated before live artifact support was enabled ΓÇö run Orbit again to publish one.',
  ...
  'settings.memoryModelInlineHintByok': 'Optional. Reuses your chat API key ΓÇö pick a cheaper model to save cost.',
  ...
  'diagnostics.exporting': 'ExportingΓÇª',
  ...
  'assistant.linkedRepoChangesTitle': 'Linked repo changes',
  'assistant.linkedRepoChangedFileSingular': '{count} changed file',
  'assistant.linkedRepoChangedFilePlural': '{count} changed files',
  'assistant.linkedRepoUntrackedFileSingular': '{count} untracked file',
  'assistant.linkedRepoUntrackedFilePlural': '{count} untracked files',
  'assistant.linkedRepoPreexistingChangeSingular': '{count} pre-existing change',
